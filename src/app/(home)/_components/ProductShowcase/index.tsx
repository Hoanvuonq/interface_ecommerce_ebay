    ...
    const fetchProducts = useCallback(async (type: 'sale' | 'new', page: number) => {
        try {
            ...
            if (productsList.length > 0) {
                if (type === 'sale') setSaleProducts((prev) => page === 0 ? productsList : [...prev, ...productsList]);
                else setNewProducts((prev) => page === 0 ? productsList : [...prev, ...productsList]);
                ...
                setHasMore(prev => ({ ...prev, [type]: currentTotal < totalElements }));
            } else {
                        ...
                        {tabConfigs.map((tab) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={cn(
                                        "relative flex items-center gap-2 px-6 py-2.5 rounded-full text-xs font-black uppercase tracking-widest transition-all duration-300 z-10",
                ...
                {loading ? (
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="flex flex-col items-center gap-6 pt-4">
                            ...
                            <Link href="/products" className="group flex items-center gap-3 px-10 py-5 bg-slate-900 text-white rounded-4xl font-black text-xs uppercase tracking-[0.2em] hover:bg-orange-600 transition-all shadow-xl shadow-slate-200 active:scale-95">
