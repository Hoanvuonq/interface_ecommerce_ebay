...
export default function UserStatistics() {
  ...
  const renderOverviewContent = () => {
    if (!overview)
      return (
        <div className="p-10 text-center text-gray-600">Không có dữ liệu</div>
      );
      ...
      <div className="animate-in fade-in duration-500">
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1 font-medium">
            Tổng quan về hoạt động và phân bố người dùng trong hệ thống
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          {Object.entries(roles).map(([role, count], index) => (
            <div
              key={role}
              className="bg-white p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 group hover:shadow-lg transition-all"
            >
              <div className="flex items-center gap-4">
                <div
                  className="p-4 rounded-2xl shadow-lg text-white"
                  style={{
                    background: `linear-gradient(135deg, ${COLORS_DATA_USER[index % COLORS_DATA_USER.length]}, ${COLORS_DATA_USER[(index + 1) % COLORS_DATA_USER.length]})`,
                  }}
                >
                  <Users size={24} />
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="flex justify-between items-center mb-8">
              <div>
                ...
                <p className="text-gray-600 text-xs font-bold">
                  Tỷ lệ các trạng thái người dùng thời gian thực
                </p>
              </div>
          ...
          <div className="lg:col-span-4 space-y-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    val: overview?.status?.INACTIVE || 0,
                  ...
                  <div
                    key={i}
                    className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl group hover:bg-white hover:shadow-md transition-all"
                  >
            ...
            <div className="bg-linear-to-br from-indigo-500 to-blue-600 p-8 rounded-3xl text-white shadow-xl">
              <h4 className="font-semibold text-white uppercase  text-[10px] mb-4 opacity-80">
                Insights
              </h4>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-3xl font-semibold tracking-tight">
                    {totalUsers > 0
                      ? ((overview?.status?.ACTIVE / totalUsers) * 100).toFixed(
                          1,
                        )
                      : 0}
                    %
        ...
        {activeTab === "time" && (
          <div className="animate-in fade-in duration-500">
            <div className="mb-8">
              ...
              <p className="text-gray-500 mt-1 font-medium">
                Phân tích xu hướng đăng ký tài khoản người dùng
              </p>
            </div>
        ...
        {activeTab === "behavior" && (
          <div className="animate-in fade-in duration-500">
            <div className="mb-8">
              ...
              <p className="text-gray-500 mt-1 font-medium">
                Phân tích hoạt động đăng nhập và tương tác
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 mb-6">
              <div className="flex flex-col md:flex-row justify-between gap-8">
                <div className="w-full md:w-1/4">
                  <label className="text-[10px] font-semibold text-gray-600 uppercase tracking-widest block mb-4">
                    Lọc thời gian
                  </label>
                  <div className="relative">
                    <select
                ...
                <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    {
                      l: "Hôm nay",
                      v: behaviorStats?.loggedInToday,
                      c: "text-blue-500",
                      b: "bg-blue-50",
                    },
                    {
                      l: "Tuần này",
                      v: behaviorStats?.thisWeekLoggedIn,
                      c: "text-emerald-500",
                      b: "bg-emerald-50",
                    },
                    {
                      l: "Tháng này",
                      v: behaviorStats?.thisMonthLoggedIn,
                      c: "text-orange-500",
                      b: "bg-orange-50",
                    },
                    {
                      l: "Năm nay",
                      v: behaviorStats?.thisYearLoggedIn,
                      c: "text-purple-500",
                      b: "bg-purple-50",
                    },
                  ].map((item, i) => (
                    <div key={i} className={`${item.b} p-4 rounded-2xl`}>
                      ...
                      <p
                        className={`text-2xl font-semibold ${item.c} tracking-tight`}
                      >
                        {item.v ?? 0}
                      </p>
                    </div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50">
              <div className="flex justify-between items-center mb-10">
                <h4 className="font-semibold text-gray-800 uppercase  text-xs">
                  Biểu đồ tăng trưởng đăng nhập
                </h4>
