  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-white rounded-xl shadow-sm group-hover:shadow-orange-100 transition-all">
            <Icon size={18} className="text-gray-600 group-hover:text-orange-500" />
          </div>
      ...
      <div className="space-y-1.5 ml-1">
        <div className="flex items-center gap-2 text-gray-600 hover:text-orange-600 transition-colors cursor-pointer group/item">
