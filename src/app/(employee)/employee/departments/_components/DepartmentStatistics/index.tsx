  ...
  return (
    <div className="p-8 bg-[#F8FAFC] min-h-screen space-y-10 animate-in fade-in duration-700">
      <div className="space-y-2">
        ...
        <p className="text-gray-600 text-xs font-bold uppercase tracking-[0.3em]">Báo cáo cấu trúc nhân sự và định biên chức vụ</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <StatCardComponents label="Tổng phòng ban" value={statistics.totalDepartments} icon={<Building2 />} color="text-gray-900" />
