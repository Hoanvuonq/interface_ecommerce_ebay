    ...
    return (
        <div className={`relative w-full ${className}`} ref={containerRef}>
            <div
                ...
                className={` w-full px-4 py-2.5 bg-white border rounded-lg cursor-pointer flex items-center justify-between transition-all duration-200 ${isOpen
                ? "border-orange-500 ring-2 ring-orange-100"
                : "border-gray-300 hover:border-orange-400"} ${loading
                    ? "opacity-70 cursor-wait"
                    : ""} `}>
                <span
                    className={`block truncate ${selectedBankObj
                ...
                <div className="ml-2 shrink-0 text-gray-400">
                    {loading
                        ...
                        : (
                            <svg
                                className={`w-5 h-5 transition-transform ${isOpen
            ...
            {isOpen && (
                <div
                    className="absolute z-50 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-100">
                    ...
                    <ul
                        className="max-h-60 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
                            ...
                            ? (filteredBanks.map((bank) => {
                                ...
                                return (
                                    <li
                                        ...
                                        className={` cursor-pointer px-4 py-2.5 text-sm transition-colors duration-150 flex items-center justify-between group ${isSelected
