          ...
          {productReviews.length === 0 && !reviewsLoading ? (
            <div className="py-12 flex flex-col items-center text-center">
              ...
              <ButtonField
                type="login"
                size="middle"
                className="rounded-full w-50 text-[12px] uppercase h-12 font-bold tracking-tight"
              >
                Viết đánh giá ngay
              </ButtonField>
            </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    {review.verifiedPurchase && (
                      <TagComponents
                        colorClass="bg-green-50 text-green-600 border-green-100 text-[11px] px-2 py-0.5"
        ...
        {reviewHasMore && (
          <div className="text-center pt-4">
            <CustomButton
              ...
              className="px-10 rounded-full border-gray-200"
            >
              Xem thêm đánh giá
            </CustomButton>
          </div>
