          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <aside className="lg:col-span-3 hidden lg:block">
              <div className="sticky top-24 space-y-4">
                <h3 className="text-xs font-bold uppercase tracking-widest text-slate-400 pl-4">Mục lục</h3>
                <nav className="space-y-1">
                  {tableOfContents.map((item) => (
                    <button
                      key={item.id}
                      onClick={() => scrollToSection(item.id)}
                      className="w-full flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-600 hover:text-orange-600 hover:bg-orange-50 rounded-xl transition-all text-left group"
                    >
            ...
            {/* Main Content */}
            <main className="lg:col-span-9 bg-white border border-slate-100 rounded-[2.5rem] p-8 md:p-12 shadow-sm prose prose-slate prose-orange max-w-none">
              ...
              <section id="collect" className="mt-12">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 list-none p-0">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-2 text-slate-600 bg-slate-50 p-3 rounded-xl m-0">
              ...
              <section id="data-types" className="mt-12">
                ...
                <div className="space-y-6">
                  <div className="p-6 border border-slate-100 rounded-2xl">
                    ...
                    <p className="text-sm text-slate-600 m-0 leading-relaxed">Tên, CCCD/Hộ chiếu, số điện thoại, email, địa chỉ giao hàng, IP, tài khoản ngân hàng, ảnh đại diện...</p>
                  </div>
                  <div className="p-6 border border-slate-100 rounded-2xl">
                    <h4 className="font-bold text-orange-600 mb-2">3.1.2. Giao dịch</h4>
                    <p className="text-sm text-slate-600 m-0 leading-relaxed">Lịch sử mua hàng, thông tin thanh toán, thông tin vận chuyển và các sản phẩm đã giao dịch.</p>
                  </div>
                </div>
              </section>
              ...
              <section id="contact" className="mt-12 pt-12 border-t border-slate-100">
                <h2 className="text-2xl font-bold text-slate-900">14. LIÊN HỆ VỚI CHÚNG TÔI</h2>
                <div className="bg-slate-900 text-white p-8 rounded-4xl mt-6">
              ...
              <footer className="mt-16 text-center text-slate-400 text-xs italic">
