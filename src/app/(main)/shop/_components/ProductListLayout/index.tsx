...
export default function ProductListLayout({
  ...
  const renderSkeletons = () => (
    <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 animate-pulse">
      {_.range(8).map((i) => (
        <div
          key={i}
          className="h-80 bg-slate-100 rounded-2xl border border-slate-50"
        />
      ))}
    </div>
  );
  ...
  return (
    <div className="flex flex-col min-h-125"> 
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 bg-white p-4 rounded-xl shadow-sm border border-slate-50 sticky top-24 z-20 transition-all duration-300">
      ...
      <div className="flex-1">
        {loading ? (
          ...
          <div className="py-32 flex flex-col items-center justify-center text-slate-400 animate-in fade-in zoom-in duration-500">
