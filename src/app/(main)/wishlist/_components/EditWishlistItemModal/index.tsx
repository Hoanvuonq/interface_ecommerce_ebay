...
import { Edit3, HelpCircle, Loader2, Minus, Plus, Save } from "lucide-react";
...
export default function EditWishlistItemModal({
  ...
  const handleSubmit = async () => {
    if (quantity < 1) {
      toastError("Số lượng phải ít nhất là 1");
      return;
    }
    ...
    try {
      ...
      if (result.success) {
        ...
        toastError(result.error || "Cập nhật thất bại");
      }
    } catch (error) {
  ...
  const modalTitle = (
    <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <p className="text-[10px] font-bold text-gray-600 uppercase tracking-widest mt-1 truncate max-w-50">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            ...
            />
            <span className="absolute right-5 top-1/2 -translate-y-1/2 font-semibold text-gray-500 group-focus-within:text-orange-300">
              ₫
            </span>
          </div>
        </div>
