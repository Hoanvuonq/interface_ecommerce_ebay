...
export const ProductShowcase = ({ title = "GỢI Ý HÔM NAY", subtitle = "Dành riêng cho bạn" }) => {
  ...
  const displayProducts = useMemo(() => {
    ...
    return _.take(list, 11); // Lấy 11 sản phẩm để ô thứ 12 là nút "Xem thêm"
      ...
      <ScrollReveal animation="slideUp" delay={150}>
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-col items-center text-center mb-4">
            ...
            <p className="text-slate-400 font-medium tracking-widest text-[11px] uppercase">
              {subtitle}
            </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-4">
            <AnimatePresence mode="popLayout">
              ...
              <motion.div
                ...
                className="h-full"
              >
                <Link href="/products" className="group h-full flex flex-col items-center justify-center p-6 bg-slate-50 border-2 border-dashed border-slate-200 rounded-2xl hover:bg-orange-50 hover:border-orange-200 transition-all duration-300">
