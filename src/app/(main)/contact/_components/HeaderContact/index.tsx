          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="max-w-2xl text-center md:text-left">
                ...
                <h1 className="text-5xl md:text-3xl font-semibold tracking-tighter mb-6 text-slate-950">
              ...
              <div className="relative w-full max-w-xs aspect-square hidden md:block">
                ...
                <div className="absolute inset-0 bg-slate-200 rounded-[3rem] -rotate-3 overflow-hidden border-4 border-white shadow-2xl">
                   <div className="w-full h-full bg-orange-500 flex items-center justify-center text-white italic font-semibold text-2xl">
                     EBAY EXPRESS
                   </div>
                </div>
              </div>
