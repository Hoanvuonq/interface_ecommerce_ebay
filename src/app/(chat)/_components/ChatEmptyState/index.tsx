...
export const ChatEmptyState: React.FC<ChatEmptyStateProps> = ({
  ...
  return (
    <div className="h-full flex items-center justify-center bg-linear-to-br from-orange-50/30 via-white to-gray-50/30">
      <div className="text-center px-8 py-12 bg-white rounded-3xl shadow-xl shadow-orange-500/5 border border-gray-100 max-w-sm mx-4 animate-in fade-in zoom-in duration-500">
        <div className="w-20 h-20 mx-auto rounded-3xl bg-linear-to-br from-orange-500 to-amber-500 flex items-center justify-center text-white mb-6 shadow-lg shadow-orange-200 rotate-3">
