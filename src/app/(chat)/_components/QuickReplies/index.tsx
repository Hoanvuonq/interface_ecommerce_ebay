  ...
  return (
    <div className="bg-white border-t border-slate-100 shrink-0">
      <button
        ...
        className="w-full px-4 py-2 text-[10px] uppercase tracking-wider font-bold text-slate-400 hover:text-orange-500 hover:bg-orange-50/50 flex items-center justify-center gap-2 transition-all"
      >
      ...
      {showQuickReplies && (
        <div className="px-4 pb-4 pt-1 bg-slate-50/50 animate-in slide-in-from-bottom-2 duration-300">
