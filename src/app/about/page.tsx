    ...
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="relative bg-white py-28 overflow-hidden border-b border-gray-50">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
          <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-orange-50 border border-orange-100 text-orange-600 text-[10px] font-black uppercase tracking-[0.2em] mb-8">
            Our Identity
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 -mt-16 relative z-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="space-y-5 text-gray-500 text-base md:text-lg font-medium leading-relaxed">
                <p>
                  <span className="text-orange-600 font-black">CaLaTha</span> là nền tảng đột phá vận hành bởi <strong className="text-gray-900">Công ty TNHH TM & DV Vận Chuyển Quốc Tế EBAY</strong>.
                </p>
                <p>
            ...
            <div className="lg:col-span-5 text-center">
              <div className="bg-linear-to-br from-orange-50 to-rose-50 p-10 rounded-[35px] border border-orange-100/50 relative group transition-all">
                  ...
                  <h3 className="text-xl font-black text-gray-800 mb-3">Đổi mới & Sáng tạo</h3>
        ...
        <div className="bg-white rounded-[40px] shadow-[0_20px_60px_rgba(0,0,0,0.03)] border border-gray-100 p-8 md:p-14 mb-20 relative overflow-hidden">
           <div className="flex items-center gap-6 mb-12">
              ...
              <h2 className="text-2xl font-black text-gray-900 uppercase tracking-tighter shrink-0">Pháp lý & Liên hệ</h2>
              <div className="h-px bg-gray-100 grow" />
           </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          <div className="bg-white p-12 rounded-[40px] border border-gray-100 shadow-sm hover:shadow-2xl hover:border-orange-200 transition-all duration-500 group">
            ...
            <h3 className="text-2xl font-black text-gray-900 mb-5 tracking-tight">Sứ mệnh</h3>
          ...
          <div className="bg-white p-12 rounded-[40px] border border-gray-100 shadow-sm hover:shadow-2xl hover:border-blue-200 transition-all duration-500 group">
            ...
            <h3 className="text-2xl font-black text-gray-900 mb-5 tracking-tight">Tầm nhìn</h3>
        ...
        <div className="bg-gray-50 border border-gray-100 rounded-[50px] p-12 shadow-inner relative overflow-hidden text-center">
            <h2 className="text-3xl font-black mb-20 uppercase tracking-widest text-gray-900">Giá trị cốt lõi</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
              {['Chất lượng', 'Tin cậy', 'Cộng đồng'].map((val, idx) => (
                <div key={val} className="relative group">
                   <div className="text-[120px] font-black text-black absolute -top-16 left-1/2 -translate-x-1/2 select-none group-hover:text-orange-100 transition-colors duration-500">0{idx+1}</div>
                   <div className="relative z-10 pt-10">
                      <h4 className="text-xl font-black text-amber-200 group-hover:text-black mb-4">{val}</h4>
