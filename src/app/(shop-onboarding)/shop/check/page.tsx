...
export default function ShopCheckPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      {/* Background Decor - Tông Cam Nhẹ */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-[20%] -left-[10%] w-[600px] h-[600px] rounded-full bg-orange-100/40 blur-3xl animate-pulse-slow" />
        <div className="absolute top-[30%] -right-[10%] w-[500px] h-[500px] rounded-full bg-amber-100/30 blur-3xl" />
      </div>
              ...
              <div className="px-6 md:px-8 pb-6">
                  <div className="bg-red-50/40 border border-red-100/60 rounded-2xl p-4 md:p-5">
                    ...
                    {_.map(
                        ...
                        (reason, section) => (
                        <div key={section} className="bg-white/80 backdrop-blur-sm p-3.5 rounded-xl border border-red-100/50 shadow-sm flex flex-col gap-1">
