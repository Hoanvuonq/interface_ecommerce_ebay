...
export const CheckoutAddressProvider = ({
  ...
  // --- State: Shop ---
  const [shopAddressesMap, setShopAddressesMap] = useState<Record<string, string>>({});
  const [shopFullAddressMap, setShopFullAddressMap] = useState<Record<string, ShopAddressInfo>>({});
        ...
        try {
          ...
          if (addresses.length > 0) {
            ...
            if (defaultAddr) {
              ...
              const pName = defaultAddr.province || defaultAddr.address?.provinceName;
