      ...
      <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden">
            ...
            <div className="space-y-4">
               ...
               <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <InputGroup label="Phường/Xã" required>
                    <input 
                      type="text" placeholder="Phường Bến Nghé"
                      className="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all"
        ...
        <div className="p-4 border-t border-gray-100 flex justify-end gap-3 bg-gray-50">
          ...
          <button 
            ...
            className="px-6 py-2.5 rounded-lg bg-orange-500 hover:bg-orange-600 text-white font-bold shadow-lg shadow-orange-200 transition-all transform active:scale-95 flex items-center gap-2"
          >
            {activeTab === 'new' ? <Plus size={18}/> : <CheckCircle2 size={18}/>}
            Xác nhận
          </button>
        </div>
      </div>
...
// Helper Component cho Input Label
