...
export const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  <div className="flex items-center cursor-pointer gap-4 p-5 rounded-2xl border border-gray-200 dark:border-slate-600 bg-white/80 dark:bg-slate-900/80 shadow-md hover:shadow-xl transition-all duration-300 group">
    <div
      className={`w-14 h-14 ${gradientFrom} ${gradientTo} rounded-xl flex items-center justify-center flex-shrink-0 border-2 border-white dark:border-slate-800 group-hover:scale-105 transition-transform duration-200 shadow`}
    >
