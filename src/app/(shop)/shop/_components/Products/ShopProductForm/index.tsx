...
// import { ActionBtn, DataTable, ButtonField } from "@/components";
...
//     try {
//       const response = await userProductService.getAll(0, 1000);
...
//             <div className="w-14 h-14 rounded-2xl overflow-hidden border border-gray-100 bg-gray-50 flex-shrink-0 relative shadow-inner">
//               {thumbUrl ? (
//                 <img
//                   src={thumbUrl}
//                   alt=""
...
//                 </span>
//                 {selectedStatus === tab.key && (
//                   <div className="absolute bottom-0 left-0 w-full h-1 bg-orange-500 rounded-full animate-in slide-in-from-left-4" />
//                 )}
//               </button>
//             ))}
//           </div>
...
//         {/* DataTable */}
//         <div className="bg-white rounded-[2.5rem] border border-gray-100 p-2 shadow-sm">
//           <DataTable
//             data={products}
//             columns={columns}
//             loading={loading}
