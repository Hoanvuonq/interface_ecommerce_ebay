...
export const ProductReviewsSection = ({
  ...
  const fetchData = async () => {
    // Fetch Statistics
    const statsRes = await getStatistics.handleGetReviewStatistics("PRODUCT" as ReviewType, productId);
    ...
    const reviewsRes = await getReviews.handleGetReviews("PRODUCT" as ReviewType, productId, params);
