    ...
    >
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0 space-y-2">
          ...
          <h4 className="font-bold text-slate-800 text-sm truncate uppercase italic group-hover:text-orange-600 transition-colors">
      ...
      <div className="grid grid-cols-2 gap-2 p-3 bg-slate-50/80 rounded-2xl border border-slate-100 italic shadow-inner">
        <div className="space-y-1">
          ...
          <div className="text-[10px] font-bold text-slate-600 bg-white py-1 px-2 rounded-lg border border-slate-200 w-fit">
      ...
      <div className="flex items-center justify-between px-2 pt-1 border-t border-slate-50 mt-1">
        ...
        <div className="flex flex-col items-end">
          <div className="flex items-center gap-1 text-[8px] font-bold text-slate-300 uppercase tracking-widest italic">
