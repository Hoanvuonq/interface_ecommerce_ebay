...
export const CustomCollapseItem: React.FC<{ category: CategoryResponse }> = ({ category }) => {
    const hasChildren = category.children && category.children.length > 0;

    const baseItemClass = "flex items-center justify-between cursor-pointer py-2.5 px-3.5 text-sm font-bold text-gray-700 hover:text-orange-600 hover:bg-orange-50 transition-all duration-200 rounded-xl group/item";
