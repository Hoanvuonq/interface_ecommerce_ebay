      ...
      <div
        className={cn(
          ...
          isVisible
            ...
            : "opacity-0 scale-50 translate-y-2.5 pointer-events-none"
        )}
        onMouseEnter={showPopover}
        onMouseLeave={hidePopover}
      >
        ...
        <div
          className="absolute w-3 h-3 bg-white transform rotate-45 border-l border-t border-gray-100 shadow-[-2px_-2px_5px_rgba(0,0,0,0.02)]"
          style={{
            left:
              placement === "bottomLeft"
                ? "14px"
