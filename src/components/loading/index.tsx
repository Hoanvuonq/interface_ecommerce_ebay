...
export const SectionLoading: React.FC<SectionLoadingProps> = ({
  ...
  return (
    <section 
      className={`min-h-[400px] flex items-center justify-center relative overflow-hidden bg-white ${className}`}
    >
      {/* Background Decor - Các đốm màu loang phong cách Web3 */}
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="relative w-20 h-20 mb-8">
          ...
          />
          {/* Vòng quay trong - quay ngược lại */}
          <motion.div
            animate={{ rotate: -360 }}
