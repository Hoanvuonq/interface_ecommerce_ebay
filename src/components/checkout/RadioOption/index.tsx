  ...
  <div 
    ...
    className={`
      ...
      ${disabled ? "opacity-50 cursor-not-allowed bg-gray-50 border-gray-100" : 
        checked ? "border-orange-500 bg-orange-50/30 ring-1 ring-orange-500" : "border-gray-200 hover:border-orange-300 bg-white hover:bg-gray-50"}
      ${className}
    `}
  >
    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 transition-colors ${checked ? "border-orange-500" : "border-gray-300"}`}>
