...
export type StockStatus = 'IN_STOCK' | 'LOW_STOCK' | 'OUT_OF_STOCK' | 'ADJUSTED' | 'UNAVAILABLE';
...
export interface OrderPreviewRequest {
    ...
    shops?: ShopSelection[];
    shippingMethod?: 'STANDARD' | 'EXPRESS' | 'ECONOMY' | 'GHN' | 'CONKIN' | 'SUPERSHIP';
...
export type CheckoutResponse = OrderPreviewResponse;
